...
export function HeroSection({
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[700px]">
      {/* Left Content */}
      <div className="flex flex-col gap-8 relative z-10 order-2 lg:order-1">
        ...
        {/* Main Title */}
        <h1 className="text-6xl md:text-8xl font-black text-white leading-[0.9] tracking-tighter mix-blend-lighten">
          {parts[0]}
        ...
        {/* Description */}
        <p className="text-slate-400 text-lg max-w-lg leading-relaxed border-l-2 border-primary/50 pl-6 bg-gradient-to-r from-primary/5 to-transparent py-2">
          {description}
        </p>
        ...
        <div className="flex flex-wrap gap-5 mt-6">
          <Link
            href="/about#contact"
            className="group relative flex items-center gap-3 px-8 h-14 rounded-full bg-white text-black font-bold transition-all hover:bg-primary hover:shadow-[0_0_40px_rgba(0,242,255,0.4)] overflow-hidden"
          >
          ...
          <Link
            ...
            target="_blank"
            className="flex items-center gap-3 px-8 h-14 rounded-full border border-white/20 text-white font-medium hover:bg-white/5 hover:border-white/40 transition-colors"
          >
