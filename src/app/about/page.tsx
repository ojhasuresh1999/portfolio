                ...
                {resumeUrl && (
                  <div className="flex gap-4 mt-2">
                    <a
                      ...
                      className="flex items-center gap-2 min-w-[160px] justify-center rounded-lg h-12 px-6 bg-primary text-black font-bold hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1 transition-all duration-300 group"
                    >
