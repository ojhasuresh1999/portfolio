...
import { useInfiniteProjects } from "@/hooks/queries";
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 py-12 sm:py-16 pt-28 sm:pt-32 relative z-10 flex flex-col overflow-hidden">
        ...
        <div className="mb-12 sm:mb-24 relative">
          ...
          <div className="flex items-center gap-6">
            ...
            {total > 0 && (
              <span className="shrink-0 text-xs font-[family-name:var(--font-mono)] text-gray-600 border border-white/5 px-3 py-1">
        ...
        {isLoading && (
          <div className="grid grid-cols-1 gap-8 sm:gap-12">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="group relative flex flex-col md:flex-row gap-5 sm:gap-8 items-stretch border border-white/5 bg-surface-dark p-4 sm:p-6 md:p-8 animate-pulse"
              >
                <div className="w-full md:w-5/12 h-48 sm:h-64 md:h-80 bg-white/5" />
        ...
        {isError && (
          <div className="p-12 text-center border border-red-500/20 bg-red-500/5">
            <span className="material-symbols-outlined text-4xl text-red-500/60 mb-4 block">
              error
            </span>
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-between py-2 z-10">
                  <div>
                    ...
                    {/* Title */}
                    <h2 className="text-white text-xl sm:text-2xl md:text-3xl font-bold font-[family-name:var(--font-mono)] mb-3 sm:mb-4 group-hover:text-primary transition-colors tracking-tight">
                      {project.title}
                    </h2>
        ...
        {isFetchingNextPage && (
          <div className="flex justify-center items-center gap-4 py-8">
            <div className="flex items-center gap-3 text-primary font-[family-name:var(--font-mono)] text-xs uppercase tracking-widest">
              <span className="w-2 h-2 bg-primary rounded-full animate-ping" />
              <span>LOADING_MORE_MODULES...</span>
            </div>
          </div>
        )}
